...
class MDPRAGAgent(RAGAgent):
    ...
    def _update_state(self, state: Dict[str, Any], action: Dict[str, Any], result: Any) -> Dict[str, Any]:
    ...
    def _execute_reformulate(self, query: str, state: Dict[str, Any], action: Dict[str, Any]) -> str:
